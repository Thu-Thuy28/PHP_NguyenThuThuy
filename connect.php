...
<head>
    ...
    <title>Connect to db_nguyen_thu_thuy</title>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                if (isset($_POST['submit'])) {
                    // Cố định tên máy chủ và cơ sở dữ liệu
                    $server = "localhost";
        ...
        <form class="row" method="POST">
            <div class="col">
                <div class="form-floating mb-3">
                    <input value="localhost" type="text" class="form-control" id="server" placeholder="Server" name="server" readonly>
                    <label for="server">Server</label>
                </div>
                <div class="form-floating mb-3">
                    <input value="db_nguyen_thu_thuy" type="text" class="form-control" id="database" placeholder="Database" name="database" readonly>
